 ...
 * @author User
 */
public class Pwchanguser extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (rs.next()) {
                String query1 = "Update login set  Password='" + jPasswordField1.getText() + "' where Username='" + user.getText() + "' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pwchanguser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pwchanguser().setVisible(true);
            }
        });
    }
